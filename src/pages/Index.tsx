...
const Dashboard = () => {
  ...
  const roleOptions = [
    ...
    },
    {
      ...
      description:
        "Oversee the entire waste management system and user accounts",
      icon: UserCog,
        ...
        >
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Your community waste management platform. Please select your role
              to continue.
            </p>
          </div>
                ...
                >
                  <CardContent className="p-6 flex flex-col h-full">
                    ...
                    <Button className="w-full mt-4 group">
                      <span>
                        {role.role === "user" ? "Continue" : "Direct Access"}
                      </span>
