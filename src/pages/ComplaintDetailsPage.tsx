  ...
  useEffect(() => {
    const loadComplaint = async () => {
      try {
        ...
        const complaintsData = (await fetchComplaints()) as any[];
        ...
        const submitter = users?.find(
          (u) => u.clerk_id === foundComplaint.user_id,
        );
        const assignedOfficer = users?.find(
          (u) => u.clerk_id === foundComplaint.assigned_to,
        );
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  {complaint.resolution && (
                    <div className="mt-6 pt-6 border-t">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Resolved by {complaint.resolution.officer} on{" "}
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <Button
                      ...
                      disabled={
                        submitting ||
                        (newStatus === "resolved" && !resolutionNotes)
                      }
                    >
                      {submitting ? (
                        <>
          ...
          <div className="space-y-6">
            ...
            {(userRole === "admin" || userRole === "officer") &&
              !complaint.assignedTo && (
                <Card className={cn("border", statusColors["pending"]?.border)}>
                  <CardContent className="p-6">
                    <div className="flex items-center gap-2 mb-2">
