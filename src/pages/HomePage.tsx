            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              >
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
                  Making Recycling <span className="text-primary">Simple</span>{" "}
                  and <span className="text-primary">Effective</span>
                </h1>
                <p className="text-xl text-muted-foreground">
                  Eco Guardian connects communities with waste management
                  services for a cleaner, greener environment.
                </p>
        ...
        <section id="features" className="py-12 md:py-24 bg-muted/30">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Eco Guardian provides a comprehensive waste management solution
                connecting community members, officers, and administrators.
              </p>
            </div>
                ...
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <p className="text-muted-foreground">
                      Easily report waste management issues with photos,
                      location, and details for quick resolution.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <p className="text-muted-foreground">
                      Follow the status of your reported complaints and get
                      notified when they're resolved.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <p className="text-muted-foreground">
                      See how your environmental concerns contribute to a
                      cleaner, more sustainable community.
                    </p>
                  </div>
                </CardContent>
              </Card>
        ...
        <section id="how-it-works" className="py-12 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Our simple 3-step process makes complaint reporting and
                resolution easy and efficient.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center bg-white p-6 rounded-lg shadow-sm border">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-primary text-background text-xl font-bold mb-4">
                  1
                </div>
                <h3 className="text-xl font-bold mb-2">Report</h3>
                <p className="text-muted-foreground">
                  Take a photo of the issue, add details, and submit your
                  complaint.
                </p>
                <img
                  src="/step1.jpg"
                  ...
                  onError={(e) => {
                    e.currentTarget.src =
                      "https://images.unsplash.com/photo-1608501821300-4f99e58bba77";
                  }}
                />
              </div>
              ...
              <div className="text-center bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-muted-foreground">
                  Officers review and update the status of your complaint.
                </p>
                <img
                  src="/step2.jpg"
                  alt="Step 2"
              ...
              <div className="text-center bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-muted-foreground">
                  Your complaint is resolved and you receive notification of
                  completion.
                </p>
                <img
                  src="/step3.jpg"
        ...
        <section className="py-12 md:py-24 bg-primary/5">
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
              Join Eco Guardian today and help create a cleaner, more
      ...
      <footer className="border-t py-8 bg-muted/40">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Connecting communities for better waste management and
                recycling.
              </p>
            </div>
          ...
          <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
            <p>
              © {new Date().getFullYear()} Eco Guardian. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
