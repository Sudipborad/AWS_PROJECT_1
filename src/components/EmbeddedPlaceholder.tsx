...
const EmbeddedPlaceholder: React.FC<EmbeddedPlaceholderProps> = ({
  height = "16rem",
  width = "100%",
  className = "",
}) => {
  return (
    <div 
      className={`rounded-md border bg-muted flex items-center justify-center ${className}`}
      style={{ height, width }}
    >
      <svg 
...
export default EmbeddedPlaceholder; 